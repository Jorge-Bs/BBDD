...
CREATE TABLE "CLIENTE_P6"
(
   DNI varchar(9) NOT NULL,
   NOMBRE varchar(40),
   CONSTRAINT PK_CLIENTE_P6 PRIMARY KEY (DNI)
);
...
(
   ...
   CONSTRAINT FK_TIENE_CLIENTE_P6 FOREIGN KEY (DNI) REFERENCES "CLIENTE_P6" (DNI),
...
(
   ...
   CONSTRAINT FK_COMPRA_CLIENTE_P6 FOREIGN KEY (DNI) REFERENCES "CLIENTE_P6" (DNI),
...
INSERT INTO "CLIENTE_P6" (DNI,NOMBRE) VALUES (1,'Paco Fernández');
INSERT INTO "CLIENTE_P6" (DNI,NOMBRE) VALUES (2,'Carmen Pérez');
INSERT INTO "CLIENTE_P6" (DNI,NOMBRE) VALUES (3,'Antonio Álvarez');
INSERT INTO "CLIENTE_P6" (DNI,NOMBRE) VALUES (4,'Bernardo Boquerón');
INSERT INTO "CLIENTE_P6" (DNI,NOMBRE) VALUES (5,'Carlos Cifuentes');
INSERT INTO "CLIENTE_P6" (DNI,NOMBRE) VALUES (6,'Damián Durán');
INSERT INTO "CLIENTE_P6" (DNI,NOMBRE) VALUES (7,'Ernesto Estévez');
INSERT INTO "CLIENTE_P6" (DNI,NOMBRE) VALUES (8,'Fernando Fidalgo');
INSERT INTO "CLIENTE_P6" (DNI,NOMBRE) VALUES (9,'José García');
INSERT INTO "CLIENTE_P6" (DNI,NOMBRE) VALUES (10,'María Iglésias');
